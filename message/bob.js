...
let Birthday = `Hitung mundur 
     ulang tahun developer, 4K Sanzz: 
	${hari} hari, 
	${jam} jam, 
	${menit} menit, 
	${detik} detik.`;
    ...
    case prefix+'tupai':
                ...
                var buttonMessage = {
                    ...
                    contextInfo: {
                        "externalAdReply": {
                            ...
                            "jpegThumbnail": global.pathImg,
                            "mediaUrl": 'youtube.com/c/4KSanzz',
                            "thumbnail": global.pathImg,
                            "thumbnailUrl": 'https://www.linkpicture.com/q/20221229_091133.jpg',
                            "sourceUrl": 'youtube.com/c/4KSanzz',
                        }
                    }
                }
            ...
            case prefix + 'creator':
                let vcard = 'BEGIN:VCARD\n' +
                    ...
                    'FN:PBZ463.\n' +
                    'ORG:4K Sanzz;\n' +
                    'item1.TEL;type=CELL;type=VOICE;waid=6281236167286:+62 812-3616-7286\n' +
...
case prefix + 'nomerhoki': case prefix + 'nomorhoki': {
                if (!Number(q)) throw `Example : ${prefix + command} 6281236167286`
